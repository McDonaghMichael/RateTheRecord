            ...
            <div className="row d-flex justify-content-center">
                <div className="card col-md-3 mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Add a new artist to the database by providing their details and
                            bio.</p>
                ...
                <div className="card col-md-3 mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Modify an existing artist’s information, including their bio and
                            image.</p>
                ...
                <div className="card col-md-3 mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Edit details of an existing album, such as artist, cover, and
                            description.</p>
